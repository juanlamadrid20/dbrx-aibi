...
AND source_path LIKE "%/Volumes/juan_dev/data_science/data_science_volume%";
...
AND request_params.volume_full_name = "juan_dev.data_science.data_science_volume";
...
AND request_params.path LIKE "/Volumes/juan_dev/data_science/data_science_volume/wind_farm/windfarm_data.csv"
GROUP BY 1
